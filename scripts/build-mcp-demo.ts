    ...
    html: `
      <div class="cover">
        ...
        <div class="cover-body">
          ...
          <h1 class="hero-title">Design<br/>Tokens<br/><em class="hero-emph">MCP</em></h1>
  ...
  },
  {
    ...
    html: `
      <header class="slide-head">
        ...
        <h2 class="slide-title">Why this <em>exists</em></h2>
  ...
  },
  {
    ...
    html: `
      <header class="slide-head">
        ...
        <h2 class="slide-title">One pipeline.<br/>One <em>upstream-ready</em> artefact.</h2>
      </header>
      <div class="arch-flow">
        <div class="arch-step">
  ...
  },
  {
    ...
    html: `
      <header class="slide-head">
        ...
        <h2 class="slide-title">Anatomy of an <em>enriched</em> token</h2>
  ...
  },
  {
    ...
    html: `
      <header class="slide-head">
        ...
        <h2 class="slide-title">Four tools.<br/>Same enriched <em>shape</em>.</h2>
      </header>
      <div class="tools">
        <article class="tool">
          <p class="tool-n">01</p>
  ...
  },
  {
    ...
    html: `
      <header class="slide-head">
        ...
        <h2 class="slide-title">Five test classes.<br/><em>Three real bugs</em> caught.</h2>
      </header>
      <ol class="harden">
  ...
  },
  {
    ...
    html: `
      <header class="slide-head">
        ...
        <h2 class="slide-title">From clone to <em>connected</em>.</h2>
      </header>
      <div class="qs">
        <div class="qs-step">
  ...
  },
  {
    ...
    html: `
      <header class="slide-head">
        ...
        <h2 class="slide-title">Two phases.<br/>One <em>direction</em>.</h2>
      </header>
      <ol class="phases">
    ...
    html: `
      <div class="cover end">
        ...
        <div class="cover-body end-body">
          ...
          <h1 class="hero-title end-title">Ready<br/>for <em class="hero-emph">daily use</em>.</h1>
          <dl class="colophon">
        ...
        <div class="cover-meta-bottom">
          <span class="ref">KEYS</span>
          <span><kbd>←</kbd> <kbd>→</kbd> navigate · <kbd>Space</kbd> index · <kbd>T</kbd> theme · <kbd>R</kbd> restart</span>
        </div>
      </div>`,
  },
];
...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .slide-title em { font-style: italic; color: var(--accent); font-weight: 700; }
    ...
    .cover-body { display: flex; flex-direction: column; justify-content: center; max-width: 22ch; }
    .hero-kicker {
      font-weight: 500;
    ...
    .topbar-counter .sep { color: var(--fg-faint); margin: 0 0.2rem; }
    .theme-toggle {
      pointer-events: auto;
...
<body data-theme="light">
  <div class="topbar">
    <span class="topbar-counter" id="counter"><span id="counter-cur">01</span><span class="sep">/</span><span>${String(slides.length).padStart(2, "0")}</span></span>
    <button type="button" class="theme-toggle" id="theme-toggle" aria-label="Toggle light or dark theme">Dark</button>
  </div>
